...
class _NavIcons {
  ...
  static const home = '$_open<path d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 '
      '001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 '
      '011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>';

  static const tasks = '$_open<rect x="6" y="4" width="4.5" height="16" '
      'rx="2.25"/><rect x="13.5" y="4" width="4.5" height="16" rx="2.25"/>'
      '</svg>';

  static const calendar = '$_open<path d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 '
      '002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>';

  static const profile = '$_open<path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 '
